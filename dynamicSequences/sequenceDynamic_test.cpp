...
// An interactive test program for the sequenceDynamic class

#include <cctype>       // Provides toupper
#include <iostream>     // Provides cout and cin
#include <cstdlib>      // Provides EXIT_SUCCESS
#include "sequenceDynamic.h"  // With value_type defined as double
using namespace std;
...
void show_sequence(sequenceDynamic display);
...
int main( )
{
    sequenceDynamic test; // A sequence that we’ll perform tests on
    ...
    do
    {
        ...
        switch (choice)
        {
            ...
            case 'R': test.remove_current( );
                      ...
                      break;     
			case 'E': if (test.erase_one(get_number()))
						cout << "The item has been removed from the container." << endl;
					  else
						cout << "The item is not in the container." << endl;
					  break;
...
// Library facilities used: iostream.h
{
	...
	cout << " E   Activate the erase_one(...) function" << endl;

...
#include "sequenceList.h"  // With value_type defined as double
using namespace std;
...
void show_sequence(sequenceList display);
...
int main( )
{
	sequenceList test; // A sequence that we’ll perform tests on
